...
class PayPage:
    ...
    def cart_input(self):
        ...
        WebDriverWait(self.__driver, 30).until(
            ...
            ((By.XPATH,
             "(//div[@class='mtsds-button__text-container' and contains(text(), 'Купить')])[1]"))
        ).click()
    ...
    def button_click(self):
        ...
        """
        WebDriverWait(self.__driver, 30).until(
            EC.visibility_of_element_located((By.XPATH, "//span[@class='radio-button__text']"))).click()

        # button = WebDriverWait(self.__driver, 30).until(
        #     EC.element_to_be_clickable((By.XPATH, "//button[contains(@class, 'button--primary') and text()='Далее']")))
